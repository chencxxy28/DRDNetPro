...
The tutorial is organized in three sections. The user is recommended to sequentially go through each section.

# Predict the agent
This section includes the content of preparing data, building the prediction model for the agent, and evaluating the model for the predicted agent. This agent is related to certain disease risk of interest and can be used to construct pseudo-dynamic networks. Please find the details in [Tutorial 1](https://chencxxy28.github.io/DRDNetPro/articles/web/Tutorial1.html)
