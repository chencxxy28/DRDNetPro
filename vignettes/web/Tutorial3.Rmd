...
p3 <- ggplot(trend_data, aes(x=hypertension_probability, y=trend_effect)) +
  ...
  labs(title="Linear trend effect for the gene TSPO", x="Risk of having hypertension", y="Trend effect")
...
p4 <- ggplot(gene_select_data_tuned_new, aes(x=hypertension_probability, y=effects, color=genes, group=genes)) +
  ...
  labs(title="Inter-behaviors to the gene TSPO", x="Risk of having hypertension", y="Effects from other genes")
